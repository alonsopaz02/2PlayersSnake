...
class Juego:
  ...
  #  def jugar(self):
   #     while(True):
    ...
    #            if(self.verificarEstadoMeta(self.estado.get_x_cabezaAzul,self.estado.get_y_cabezaAzul)):
     #               self.ganador = "Azul"
      #              break
       #         if(self.verificarEstadoMeta(self.estado.get_x_cabezaRoja,self.estado.get_y_cabezaRoja)):
        #            self.ganador = "Rojo"
         #           break
          #  else:
